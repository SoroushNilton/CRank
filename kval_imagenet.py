...
def calc_avg_std():
    ...
    for num_of_filters in range(len(dict_of_ranks[0])):
        dummy_list = []
        list_of_avg_std = []
        for num_of_classes in range(1000):
...
Gives 1000 features per filter in a dictionary
...
path_to_ranks = "./"
prefix = "rank_conv/" + 'resnet_50' + "/rank_conv"
subfix = ".npy"
...
for LAYER_NUMBER in range(1, 54):
    ...
    list_of_features = np.zeros((len(dict_of_10_features), 1000))
